...
#Hard code as 1 CPU rather than 4.
nj=2
cmd=run.pl
...
# Make model/mfcc and model/exp/make_mfcc/[train_yesno|test_yesno]
...
# since we're running make_mfcc.sh for both the training and testing
# data, this next line will evaluate as model/data/test_yesno/wav.scp and
# as model/data/train_yesno/wav.scp
scp=$data/wav.scp
