...
#    cat input/task.arpabo | arpa2fst - | fstprint | utils/eps2disambig.pl | \
    cat ${language_model} | arpa2fst - | fstprint | utils/eps2disambig.pl | \
        utils/s2eps.pl | fstcompile --isymbols=$test/words.txt \
