...
mkdir -p $lang_out/phones || exit 1;
...
cp -r $lang/phones/ $lang_out/phones
...
${PATH_TO_KALDI}/egs/nextiva_recipes/utils/sym2int.pl $lang_out/phones.txt <$lang_out/phones/align_lexicon.txt >$lang_out/phones/align_lexicon.int

# L and L_disambig are the same.
cp $lang_out/L.fst $lang_out/L_disambig.fst

#${PATH_TO_KALDI}/egs/nextiva_recipes/utils/validate_lang.pl --skip-disambig-check $lang_out || exit 1;
