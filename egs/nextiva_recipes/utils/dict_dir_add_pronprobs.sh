...
. ${PATH_TO_KALDI}/egs/nextiva_recipes/path.sh || exit 1;
...
if [[ $# -ne 3 && $# -ne 5 ]]; then
  ...
  echo "data and getting the prons using tools/nextiva_tools/analysis/get_prons.sh, and creates a modified"
