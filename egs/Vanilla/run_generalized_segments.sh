...
#Script: run_generalized_segments.sh
#Author: Multiple
...
#Example Command Line: ./run_generalized_segments.sh -p 4 -n /Volumes/My_Passport_Mac/TED_Kaldi_Files/TED_wav/train/ -t /Volumes/My_Passport_Mac/TED_Kaldi_Files/TED_wav/test/ -i /Volumes/poo/ASR/egs/Input_Folders/input_V2/ -g /Volumes/poo/ASR/egs/Input_Folders/Segments_folder/segmentsTRAIN -z /Volumes/poo/ASR/egs/Input_Folders/Segments_folder/segmentsTEST
...
# -n and -t flags used (data already split)
    ...
    #added fourth parameter to include split amount for training
    # (used in create_waves_test_train.pl inside prepare data)
    local/prepare_data_generalized_segments.sh "" $train_dir $test_dir $sDefault || \
    printf "\n####\n#### ERROR: prepare_data.sh \n####\n\n";
