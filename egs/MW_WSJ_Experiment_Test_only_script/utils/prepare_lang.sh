...
# This script prepares (1) a directory such as data/lang/, in the standard
# format, given a source directory containing a dictionary lexicon.txt in a form
# like: word phone1 phone2 ... phoneN
...
# lexicon.txt exists.
# and also files (2) silence_phones.txt, (3) nonsilence_phones.txt,
# (4) optional_silence.txt and (5) extra_questions.txt
