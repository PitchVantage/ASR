...
#Purpose:  Works with Vanilla egs folder framework.
...
#Remove folders with audio files:
#rm -rf waves_dir train_dir test_dir
...
rm -rf data/test_dir exp/make_mfcc/test_dir mfcc/cmvn_test* mfcc/raw_mfcc_test*  data/lang_test_tg exp_triphones_graph data/local/lm_tg.arpa
